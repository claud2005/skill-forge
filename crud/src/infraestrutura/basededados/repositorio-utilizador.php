...
function registarUtilizador($utilizador)
{
    ...
    function apagarUtilizadorPorId($id) {
        // Supondo que você tenha um objeto de conexão $pdo configurado
        global $pdo;
    
        // Prepara a query SQL para excluir o utilizador
        $sql = "DELETE FROM utilizadores WHERE id = :id";
        
        // Prepara a execução da query
        $stmt = $pdo->prepare($sql);
        
        // Faz o bind do valor do id
