...
/**
 * FUNÇÃO PARA SIMULAR LOGIN DE UTILIZADOR.
 */
...
function logout()
{
    ...
    // REFORÇA A GARANTIA DE APAGAR COOKIES UTILIZADOS NO SISTEMA
    setcookie('id', '', time() - 3600, "/");
    setcookie('nome', '', time() - 3600, "/");

    $home_url = 'http://' . $_SERVER['HTTP_HOST'] . '/index.php'; // Aqui redireciona para a página inicial (index.php)
header('Location: ' . $home_url);
exit();
}